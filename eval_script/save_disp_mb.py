...
parser = argparse.ArgumentParser(description='ISSGA')
...
args.outdir = args.outdir + "/" + time.asctime()
def main():
    ...
    for inx in range(len(test_left_img)):
        ...
        with open('%s/%s/timeISSGA.txt'%(args.outdir,idxname.split('/')[0]),'w') as f:
             f.write(str(ttime))
